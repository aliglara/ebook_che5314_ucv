...
```{r fig003024, out.width="85%", echo=FALSE, fig.align='center', fig.cap='Comparison of concentration profile for a PFR', fig.lp='fig:'}
library(png)
library(grid)
...
```{r fig003025, out.width="85%", echo=FALSE, fig.align='center', fig.cap='Comparison of concentration and temperature profile for an adiabatic CSTR and adiabatic PFR', fig.lp='fig:'}
library(png)
library(grid)

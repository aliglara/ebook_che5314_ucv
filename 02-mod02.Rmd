...
A batch reactor operating at **constant pressure** or the fluid is incompressible, then Eq. \@ref(eq:ec003004) reduces to
\begin{equation}
...
```{r fig0030203, fig.align='center', fig.cap='Conversion and temperature in a batch reactor (Case I)', echo=FALSE, fig.lp='fig:'}
library(png)
library(grid)
...
```{r fig0030204, fig.align='center', fig.cap='Conversion and temperature in a batch reactor (Case II)', echo=FALSE, fig.lp='fig:'}
library(png)
library(grid)
...
```{r fig003004, fig.align='center', fig.cap='Dynamic simulation of a batch reactor', echo=FALSE, fig.lp='fig:'}
library(png)
library(grid)
...
```{r fig003005, fig.align='center', fig.cap='Effect of size reactor over dynamic behavior of a BR', echo=FALSE, fig.lp='fig:'}
library(png)
library(grid)

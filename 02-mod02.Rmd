...
```{r CSTRseriesdifV, out.width = "60%", echo=FALSE, fig.align='center', fig.cap='Graphical representation of two CSTRs in series'}
knitr::include_graphics("figures/CSTR_series_difV.png")
```
...
```{r CSTRseriesdifV2, out.width = "60%", echo=FALSE, fig.align='center', fig.cap='Graphical representation of two CSTRs in series', fig.lp='fig:'}
library(png)
library(grid)
...
```{r CSTRseriesminV, out.width = "60%", echo=FALSE, fig.align='center', fig.cap='Graphical representation of the minimum total reaction volume for two CSTRs in series'}
knitr::include_graphics("figures/CSTR_series_minV.png")
```
...
knitr::include_graphics("figures/003_draw_000.png")
```
...
```{r fig003005aaa, out.width = "50%", echo=FALSE, fig.align='center', fig.cap='Typical $HPR(T)$ and $HWR(T)$ curves versus temperature, $T$, for an irreversible, exothermic reaction in an ideal CSTR'}
knitr::include_graphics("figures/003_draw_006.png")
```
...
```{r fig003007, out.width = "65%", echo=FALSE, fig.align='center', fig.cap='Graphical indication of multiple steady-states solutions'}
knitr::include_graphics("figures/003_04_001.png")
```
...
```{r fig003008, out.width = "65%", echo=FALSE, fig.align='center', fig.cap='Graphical solutions of the heat balance for a CSTR'}
knitr::include_graphics("figures/003_04_002.png")
```
...
```{r fig003009, out.width = "65%", echo=FALSE, fig.align='center', fig.cap='Qualitative shape of HPR/HPWR curve for several kind of reactions'}
knitr::include_graphics("figures/CSTR_draw_05.png")
```
#### Internal Coil {-}
...
In a PFR, the composition of the fluid varies from point to point along a flow path. Thus the material balance for a reaction component must be made for a differential element dV, as shown in Figure \@ref(fig:fig002016).

```{r fig002016, out.width = "65%", echo=FALSE, fig.align='center', fig.cap='Plug-flow reactor volume element'}
knitr::include_graphics("figures/002_pfr_01.png")
```
...
```{r fig002017, out.width = "65%", echo=FALSE, fig.align='center', fig.cap='Graphical interpretation of design equation for a PFR'}
knitr::include_graphics("figures/002_pfr_02.png")
```
...
```{r figlect00701, echo=FALSE, out.width = "60%", fig.cap='Fractional conversion vs volume for various reaction orders', fig.align='center'}
knitr::include_graphics("figures/lect007_01.png")
```
...
```{r fig003009a, out.width = "45%", echo=FALSE, fig.align='center', fig.cap='PFR reactor volume element'}
knitr::include_graphics("figures/003_draw_007.png")
```
...
:-------------------------:|:---------------------------:
![](figures/lect008_01.png){width=48%}  | ![](figures/lect008_02.png){width=48%}
...
:-------------------------:|:-------------------------:
![](figures/lect009_01.png){width=48%}  |  ![](figures/lect009_02.png){width=48%}
...
```{r fig002021, echo=FALSE, out.width = "60%", fig.cap='Recycle PFR', fig.align='center'}
knitr::include_graphics("figures/002_pfr_recycle.png")
```
...
```{r fig003005, out.width="70%", fig.align='center', fig.cap='Effect of size reactor over dynamic behavior of a BR', echo=FALSE, fig.lp='fig:'}
library(png)
library(grid)
...
![](figures/complexreactions01.png){width=22%}
</center>
...
![](figures/complexreactions02.png){width=30%}
...
![](figures/complexreactions03.png){width=30%}
...
![](figures/complexreactions04.png){width=30%}
...
![](figures/complexreactions05.png){width=25%}

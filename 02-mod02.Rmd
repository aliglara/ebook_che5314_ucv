...
\begin{equation}
	\boxed{\frac{C_{A,N}}{C_{A0}} = \frac{C_{A,1}}{C_{A0}} \frac{C_{A,2}}{C_{A,1}} \cdots \frac{C_{A,N-1}}{C_{A,N}} = \frac{1}{{\left( 1 + \tau_N\, k\right)}^N}}
(\#eq:002045)
\end{equation}
...
Figure \@ref(fig:002014) shows the variation of conversion vs. the number of reactors in series for a first-order reaction. Figure \@ref(fig:002014)(a) also indicates that the Damkholer number is a crucial parameter to decide the optimal number of CSTRs required to reach an overall conversion.

In general, while the Damkholer number increases, the system will require fewer CSTRs to get the desired level of conversion. [solution](\href{file:\folder/lect_004CSTRSeries.m}{$m$ file})

...
For each scenario, the equation \@ref(eq:ec004041f) was applied to calculate the estimated $\mathbf{F}(t)$, then based on Eq. \@ref(eq:ec004041d), the output tracer concentration, $C_{out}(t)$, may be calculated from $\mathbf{F}(t)$.

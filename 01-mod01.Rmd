...
```{r sollect01, out.width = "80%", echo=FALSE, fig.align='center', fig.cap='Concentrations vs time for parallel reactions. Left, k1 = 2, Right: k1 = 4', fig.lp='fig:'}
library(png)
library(grid)
...
```{r sollect02, out.width = "80%", echo=FALSE, fig.align='center', fig.cap='Concentrations vs time for series reactions. Left, kb = 2, Right: kb = 4', fig.lp='fig:'}
library(png)
library(grid)

...
The graphical solution for this sample is (file)

<center>
![Concentrations vs time for parallel reactions. Left, k1 = 2, Right: k1 = 4](figures/sollect01.png){width=50%}
</center>

In figure \@ref(figures), we could see that more product B is generated at higher $k_B$ values concerning $k_C$. This behavior is represented in terms of the **Selectivity (S)** to the desired product:
